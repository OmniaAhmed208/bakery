    ...
    <!-- ============================ intro =================== -->
      ...
      {{-- <div class="container">
        <div id="carouselExampleControls" class="carousel slide d-none d-sm-block" data-bs-ride="carousel">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <div class="bread-menu d-flex">
                <div class="content">
                  <div class="imgBox">
                    <img src="img/sweetDinnerRolls.jpg" class="img-fluid" alt="">
                  </div>
                  <div class="title">
                    <h3 class="mt-4">Sweet dinner rolls</h3>
                    <p class="smallTitle fw-bold">boutiqe bread</p>
                  </div>
                  <hr class="text-black-50 m-4">
                  <div class="features d-flex">
                ...
                <div class="content">
                  <div class="imgBox">
                    <img src="img/bread1.jpg" class="img-fluid" alt="">
                  </div>
                  <div class="title">
                    <h3 class="mt-4">Corwason</h3>
                    <p class="smallTitle fw-bold">boutiqe bread</p>
                  </div>
                  <hr class="text-black-50 m-4">
                  <div class="features d-flex">
                ...
                <div class="content">
                  <div class="imgBox">
                    <img src="img/white bread.jpg" class="img-fluid" alt="">
                  </div>
                  <div class="title">
                    <h3 class="mt-4">White bread</h3>
                    <p class="smallTitle fw-bold">boutiqe bread</p>
                  </div>
                  <hr class="text-black-50 m-4">
                  <div class="features d-flex">
          ...
          <div class="carousalBtns">
            <button class="prevBtn d-flex align-items-center justify-content-center" type="button" data-bs-target="#carouselExampleControls" data-bs-slide="prev">
              <span class="carousel-control-prev-icon" aria-hidden="true"></span>
              <span class="visually-hidden">Previous</span>
            </button>
            <button class="nextBtn d-flex align-items-center justify-content-center" type="button" data-bs-target="#carouselExampleControls" data-bs-slide="next">
        ...
        <div id="carouselSmallScreen" class="carousel slide d-sm-none" data-bs-ride="carousel">
          ...
          <div class="carousalBtns d-flex justify-content-center">
            <button class="prevBtn d-flex align-items-center justify-content-center" type="button" data-bs-target="#carouselSmallScreen" data-bs-slide="prev">
              <span class="carousel-control-prev-icon" aria-hidden="true"></span>
              <span class="visually-hidden">Previous</span>
            </button>
            <button class="nextBtn d-flex align-items-center justify-content-center" type="button" data-bs-target="#carouselSmallScreen" data-bs-slide="next">
              <span class="carousel-control-next-icon" aria-hidden="true"></span>
              <span class="visually-hidden">Next</span>
            </button>
          </div>
